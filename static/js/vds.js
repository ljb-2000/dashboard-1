                ...
                return s = null,
                                        ...
                                        return function(e, r, n, i) {
                                            ...
                                            if (r.length > 0 && !document.body.className.match(/\bvds-entrytext\b/)) {
                                                ...
                                                if (u.e = o,
                                                    o.length > 0)
                                                    return f.push(u),
                                                        0 > C ? t.sendQueue() : (t.queueTimeout && clearTimeout(t.queueTimeout),
                    ...
                    t.prototype.getLeafNodes = function(t, e) {
                        ...
                        if (o = [],
                            ...
                            c && ((null != (f = t.attributes) ? f.any : void 0) || t.text) && (t.text || (n = t.dom,
                                t.text = n ? u.containerElemContent(n) : d.parentOfLeafText(t)),
                    ...
                    t.prototype.nodeMessage = function(t, e) {
                        ...
                        (r = t.attributes) && r.href && 0 !== r.href.indexOf("javascript") && (n.h = d.normalizePath(r.href.slice(0, 320)),
                                ...
                                return function(r) {
                                    ...
                                    if (!document.body.className.match(/\bvds-entrytext\b/)) {
                                        for (t.lastActionTime = +Date.now(),
                                                 c = r.target || r.srcElement; c && 1 === S[c.tagName] && c.parentNode; )
                                            c = c.parentNode;
                                        if (n = u.path(c, !0),
                                                n.isIgnore)
                                            return;
                                        if (a = c.tagName,
                                            ...
                                            if (-1 !== d.indexOf(e, a))
                                                return;
                                            if ("INPUT" === a && -1 === d.indexOf(y, c.type))
                                                return;
                                            if (-1 === d.indexOf(O, a) && !u.depthInside(c, 4))
                                                return
                                        }
                    ...
                    t.prototype.compute = function(t, e) {
                        ...
                        if (i = {},
                                N = e.tagName,
                                "IMG" === N ? (null != (b = e.src) ? b.length : void 0) > 0 && -1 === e.src.indexOf("data:image") && (i.h = e.src) : d.hasAttr(e, "href") && (o = e.getAttribute("href"),
                                    o && 0 !== o.indexOf("javascript") && (i.h = d.normalizePath(o.slice(0, 320)))),
                            ...
                            if (u.isLeaf(e))
                                if ("IMG" === N)
                                    e.alt ? i.v = e.alt : i.h && (c = i.h.split("?")[0],
                                            s = c.split("/"),
                                        s.length > 0 && (i.v = s[s.length - 1]));
                                else if ("INPUT" === N && -1 !== d.indexOf(y, e.type))
                                    i.v = e.value;
                                else if ("svg" === N)
                                    for (O = e.childNodes,
                                             a = 0,
                                ...
                                -1 !== d.indexOf(w, N) ? (n = u.containerElemContent(e),
                                    u.isParentOfLeaf(e) && !u.onlyContainsChildren(e, m) ? (g = d.parentOfLeafText(e),
                                        g === n ? i.v = n : (i.v = g,
                                            i.obj = n || "")) : i.v = n) : u.isParentOfLeaf(e) && (i.v = d.parentOfLeafText(e));
                        else if ("change" === t)
                            "TEXTAREA" !== N && ("INPUT" === N && (-1 !== d.indexOf(v, e.type) || "password" !== e.type && (d.hasAttr(e, "growing-track") || d.hasAttr(e, "data-growing-track"))) || "SELECT" === N) && (i.v = e.value);
                        else if ("submit" === t)
                            for (C = e.getElementsByTagName("input"),
                                     l = 0,
                                     p = C.length; p > l; l++)
                                h = C[l],
                                ("search" === h.type || "text" === h.type && ("q" === h.id || -1 !== h.id.indexOf("search") || -1 !== h.className.indexOf("search") || "q" === h.name || -1 !== h.name.indexOf("search"))) && (i.x = u.path(h).xpath,
                                    i.v = h.value.trim());
                        return i
                    }
                    ,
                    ...
                    t.prototype.pageChanged = function() {
                        ...
                        return t = d.path(),
                            ...
                            this.currentQuery && this.currentQuery.trim().length > 0 && (this.prevUrl += "?" + this.currentQuery)),
                                ...
                                null != (r = this.messagingObserver) ? r.sendPageLoad(l) : void 0) : void 0
                    }
                    ,
            ...
            i = function() {
                function t(t) {
                    ...
                    p.hasAttr(t, "data-growing-idx") && (this.grIdx = parseInt(t.getAttribute("data-growing-idx"))),
                        "input" === this.name && p.hasAttr(t, "name") && t.getAttribute("name") ? this.klass = [t.getAttribute("name")] : (e = null != (r = p.getKlassName(t, d)) ? r.replace(o, "").trim() : void 0,
                        (null != e ? e.length : void 0) > 0 && (this.klass = e.split(/\s+/).sort()))
                }
                ...
                path: function(t, e) {
                    ...
                    for (r = new i(t); "body" !== r.name && "html" !== r.name; ) {
                        if (l = r.path(),
                            ...
                            !d && r.hasIdx() && (d = !0,
                                s = r.grIdx),
                            e && "" !== a && (-1 !== p.indexOf(f, r.node.tagName) || r.isContainer()))
                            return o = this.path(r.node),
                                n = {
                                    x: o.xpath,
                                    h: r.href,
                                ...
                                d ? (n.idx = s,
                                    v.idx = s) : o.idx ? (n.idx = o.idx,
                                    v.idx = o.idx) : (-1 !== o.xpath.indexOf("/dl") || -1 !== o.xpath.indexOf("/tr") || -1 !== o.xpath.indexOf("/li")) && (n.idx = this.index(r.node)),
                                c ? (n.obj = u,
                                    v.obj = u) : o.obj && (n.obj = o.obj,
                                        v.obj = o.obj),
                    ...
                    t.prototype.sendRemote = function(t, e) {
                        ...
                        if (u = this.urlMap[e],
                            ...
                            if (i = new XMLHttpRequest,
                                ...
                                return i.open("POST", u + "?stm=" + +Date.now(), !0),
                                    i.withCredentials = !0,
                            ...
                            if ("undefined" != typeof XDomainRequest)
                                ...
                                "http:" === document.location.protocol && (u = u.replace("https://", "http://")),
                                    ...
                                    i.send(t),
                                    r.push(i)
                        } else if ("http:" === document.location.protocol && (u = u.replace("https://", "http://")),
                                o = u + "?data=" + t + "&stm=" + +Date.now(),
                            o.length <= 2036)
                ...
                return e = "0.64",
                    ...
                    t.prototype.connect = function(t) {
                        ...
                        if (a = window.navigator.userAgent.toLowerCase(),
                                a.match(/(bot|crawler|spider|scrapy|jiankongbao|slurp|transcoder|networkbench)/i)) {
    ...
    14: [function(t, e, r) {
        var n = {
            ...
            setItem: function(t, e, r, i, o, a) {
                for (var s = 0; s < o.length && (n.setItem(t, e, r, i, o[s], a),
                    !n.getItem(t)); s++)
                    ;
            }
        };
